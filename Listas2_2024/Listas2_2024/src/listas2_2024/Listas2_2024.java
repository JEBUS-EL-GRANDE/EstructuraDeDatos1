...
//        Nodo x, y, z;
//
//        x = new Nodo(p.getDataInt(), new Nodo(p.getLink().
//                getDataInt(), new Nodo(p.getLink().
//                        getLink().getDataInt(), new Nodo(p.getLink().
//                                getLink().getLink().getDataInt(), new Nodo(p.getLink().
//                                        getLink().getLink().getLink().getDataInt(), new Nodo(p.getLink().
//                                                getLink().getLink().getLink().getLink().getDataInt(), new Nodo(p.getLink().
//                                                        getLink().getLink().getLink().getLink().getLink().getDataInt(), new Nodo(p.getLink().
//                                                                getLink().getLink().getLink().getLink().getLink().getLink().getDataInt(), Nodo.TIERRA))))))));
